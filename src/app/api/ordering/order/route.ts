...
export async function POST(req: NextRequest) {
  ...
  if (body.lines.length > 30) return bad("That is a catering order. Use the catering page and the truck will come to you.");
  ...
  if (state.pausedUntil !== null) {
    return bad("The truck just paused online ordering. Give it a few minutes.", 409);
  }
